...
//user6 based combos
if ( $this->CountModules( 'user6' ) and ( empty( $_REQUEST['task'] ) || $_REQUEST['task'] != 'edit' ) ) {
      $user6 = 1;
}
//user7 based combos
if ( $this->CountModules( 'user7' ) and ( empty( $_REQUEST['task'] ) || $_REQUEST['task'] != 'edit' ) ) {
      $user7 = 1;
}
//user8 based combos
if ( $this->CountModules( 'user8' ) and ( empty( $_REQUEST['task'] ) || $_REQUEST['task'] != 'edit' ) ) {
      $user8 = 1;
}
?>
